...
public class PutAssignmentByIdRequest {
    private long id;
    ...
    public PutAssignmentByIdRequest() {
    }

    public PutAssignmentByIdRequest(long id) {
        this.userId = id;
    }

    public PutAssignmentByIdRequest(Builder builder) {
    ...
    public static final class Builder {
        ...
        public PutAssignmentByIdRequest build() { return new PutAssignmentByIdRequest(this); }
    }
}
